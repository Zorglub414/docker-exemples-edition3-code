...
python2 ../../application-exemple/build/replacer/replacer.py global.properties front-end/application.properties
...
python2 ../../application-exemple/build/replacer/replacer.py global.properties back-end/config.json
